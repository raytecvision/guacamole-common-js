        ...
        */
        ...
        this.sendMessage = function (elements) {
            ...
            for(let item of arguments){
                strArr.push(String(item).length + "." + item)
            }
            socket.emit('from_client', strArr.toString() + ";");
        };
        ...
        this.connect = function (data) {
            ...
            socket.on('agent_connected', function () {
                tunnel.setState(Guacamole.Tunnel.State.OPEN);
            });

            socket.on('client_needs_disconnect', function () {
